...
class LdapFactory extends AbstractFactory
{
    ...
    {
        return 'dosi_auth.security.authentication.listener';
    }
    ...
    protected function createAuthProvider(ContainerBuilder $container, $id, $config, $userProviderId)
    {
        ...
        $provider = 'dosi_auth.security.authentication.provider.'.$id;
        $container
            ->setDefinition($provider, new DefinitionDecorator('dosi_auth.security.authentication.provider'))
            ->replaceArgument(0, new Reference($userProviderId))
    ...
    {
        $entryPointId = 'dosi_auth.security.authentication.form_entry_point.'.$id;
        $container
            ->setDefinition($entryPointId, new DefinitionDecorator('dosi_auth.security.authentication.form_entry_point'))
